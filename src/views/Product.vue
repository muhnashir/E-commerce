                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="product-thumbs">
                                <carousel class="product-thumbs-track ps-slider" :dots="false" :nav="false">
                                    <div class="pt" @click="ChangeImage(thumbs[0])" :class="thumbs[0]==gb_default ? 'active':'' ">
                                        <img src="img/mickey1.jpg" alt="" />
                                    </div>

                                    <div class="pt" @click="ChangeImage(thumbs[1])" :class="thumbs[1]==gb_default ? 'active':'' ">
                                        <img src="img/mickey2.jpg" alt="" />
                                    </div>

                                    <div class="pt" @click="ChangeImage(thumbs[2])" :class="thumbs[2]==gb_default ? 'active':'' ">
                                        <img src="img/mickey3.jpg" alt="" />
                                    </div>

                                    <div class="pt" @click="ChangeImage(thumbs[3])" :class="thumbs[3]==gb_default ? 'active':'' ">
